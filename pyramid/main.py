...
def main():
    ...
    assert(pyramid.get_height(2) == 2)
    assert(pyramid.get_height(3) == 2)
    assert(pyramid.get_height(7) == 4)
    assert(pyramid.get_height(10) == 4)
    assert(pyramid.get_height(16) == 6)
    ...
    # assert(pyramid.get_max_blocks(3) == 7)
    ...
    # assert(pyramid.get_min_blocks(2) == 2)
    # assert(pyramid.get_min_blocks(3) == 4)
    # assert(pyramid.get_min_blocks(4) == 7)
    # assert(pyramid.get_min_blocks(5) == 11)
    # assert(pyramid.get_min_blocks(6) == 16)
